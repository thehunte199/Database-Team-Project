...
<?php
    include("access.txt");
    mysql_query("INSERT INTO uses(projectName, partNumber, dateUsed)
        VALUES
        ('$_POST[projectName]','$_POST[partNumber]','$_POST[dateUsed]')",$mydb);
    if (!$insert)
    {
...
<?php
    ...
    $result = @mysql_query("SELECT * FROM uses", $mydb);
